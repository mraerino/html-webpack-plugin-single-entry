    ...
    constructor(opts) {
        this.compilation = (compilation) => {
            if (html_webpack_plugin_1.default.getHooks) {
                html_webpack_plugin_1.default.getHooks(compilation).beforeAssetTagGeneration.tap(PLUGIN, this.beforeAssetTagGeneration(compilation));
            }
            else {
...
exports.default = HtmlWebpackPluginSingleEntry;
